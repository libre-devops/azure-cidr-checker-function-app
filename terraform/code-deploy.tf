locals {
  ...
  dependencies_install     = "import subprocess; subprocess.check_call(['pip3', 'install', '--target', '${local.code_path}/.python_packages/lib/site-packages', '-r', '${local.dependencies_path}'])"
